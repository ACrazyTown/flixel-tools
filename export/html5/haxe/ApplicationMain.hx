...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("adjustment-tool", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("adjustment-tool", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "adjustment-tool";
		app.meta["name"] = "adjustment-tool";
